#ifndef RCPPSVAEIGENSUGAR_H
#define RCPPSVAEIGENSUGAR_H
...
// dissimilarity metrices pearson correlation
template<class T>
inline typename T::Scalar cor(const T& t, const T& u) {
  return t.dot(u) / (t.norm() * u.norm());
}
